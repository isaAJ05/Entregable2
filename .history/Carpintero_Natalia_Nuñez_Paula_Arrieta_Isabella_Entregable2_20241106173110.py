...
def portafolio_maximo_beneficio():
    ...
    for portafolio in portafolios_validos: #para cada portafolio valido (lista)
        rendimiento_total = 0
        for accion in portafolio:
            rendimiento_total += rendimientos[accion]
            rendimiento_promedio = rendimiento_total / len(portafolio)
